...
|displayName<sup>*</sup>|String|Contains the long-form name for the language. |
...
|tag<sup>*</sup>|String|Contains the four-character BCP47 name for the language (en-US, no-NB, en-AU).|
